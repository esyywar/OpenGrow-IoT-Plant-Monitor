...
mqtt_pubData:register(60000, tmr.ALARM_AUTO, function()
    ...
    client:publish(mqtt_cfg.pubTopics.soil, soilData, mqtt_cfg.qos, 0)
    client:publish(mqtt_cfg.pubTopics.light, lightData, mqtt_cfg.qos, 0)
end)
...
function mqtt_data_connect()
    client:connect(mqtt_cfg.host, mqtt_cfg.port, false, 
        function() 
            print('Mqtt broker connected') 

            -- subscribe to topic
            client:subscribe(mqtt_cfg.subTopics, function() print('ESP8266 subscribed') end)
