...
const howItWorksSteps = [
  ...
  {
    stepNum: 2,
    text: "Start up the OpenGrow application and create a plant using Postman. Note the plant's ID!",
    img: require("../../media/randoGoat.jpg"),
    imgAlt: "Create plant with postman.",
  },
  {
    stepNum: 3,
    text: "Flash the ESP8266 firmware with appropriate Wifi, plant ID and server IP address credentials.",
    img: require("../../media/randoGoat.jpg"),
  ...
  {
    stepNum: 5,
    text: "Start up the OpenGrow service and leave it running to collect data and control your plant!",
    img: require("../../media/randoGoat.jpg"),
    imgAlt: "Run OpenGrow.",
  },
]
