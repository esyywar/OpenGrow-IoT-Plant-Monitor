				...
				<Grid item container spacing={6} direction="row" alignItems="center" justify="center">
					...
					<Grid item xs={11} lg={6}>
						...
						>
							...
							<Typography variant="body1" className={classes.cardInfoText}>
								Track the soil moisture and light availability for your plant. Adjust setpoints
								anytime from anywhere to ensure your plant gets watered when it needs to!
							</Typography>
						</Paper>
					</Grid>
				</Grid>
