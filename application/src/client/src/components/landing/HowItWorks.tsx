          ...
          <Typography component='div' align='center' variant='h4'>
            ...
            <Paper style={{ backgroundColor: theme.palette.background.paper }}>
              <p className={classes.cardCaption}>
                OpenGrow is easy to set-up. Follow the 5 steps below and enjoy the convenience of being able to monitor
                and take care of your plants from anywhere at anytime!
              </p>
            </Paper>
          </Typography>
          <StepsCarousel />
